...
#### 2.1.3 Suicide Count Per Country 

Similar to section 2.1.2, here we will also group by the year first and then subgroup a second time based on country. We will do something differently however. Let's first see how many possible values we have in the country attribute.
